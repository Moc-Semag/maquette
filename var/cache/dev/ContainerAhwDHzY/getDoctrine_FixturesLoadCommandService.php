...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AnswerFixture(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\CategoryFixture(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\LevelFixture(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\QuestionAnswerFixture(), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\QuestionFixture(), 'groups' => []], 6 => ['fixture' => new \App\DataFixtures\UserFixtures(new \Symfony\Component\PasswordHasher\Hasher\UserPasswordHasher(($container->privates['security.password_hasher_factory'] ?? $container->load('getSecurity_PasswordHasherFactoryService')))), 'groups' => []]]);
